...
import com.app.threads_clone.adapter.GuestListAdapter;
import com.app.threads_clone.app.App;
import com.app.threads_clone.constants.Constants;
import com.app.threads_clone.model.Guest;
...
//        mRecyclerView.addItemDecoration(new GridSpacingItemDecoration(Helper.getGridSpanCount(getActivity()), dpToPx(10), true));
        ...
        ivDelete = (ImageView) getActivity().findViewById(R.id.ivDelete);
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), mRecyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Guest guest = (Guest) itemsList.get(position);
    ...
    private void dialogDelete() {
        View  view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_delte, null);
        BottomSheetDialog dialog = new BottomSheetDialog(getActivity(), R.style.AppBottomSheetDialogTheme);
        dialog.setContentView(view);
        dialog.setCancelable(true);

        ConstraintLayout clRoot= dialog.findViewById(R.id.clRoot);

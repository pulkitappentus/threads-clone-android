...
import com.app.threads_clone.adapter.GiftsListAdapter;
import com.app.threads_clone.app.App;
import com.app.threads_clone.constants.Constants;
import com.app.threads_clone.model.Gift;
...
public class GiftsFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tvHeading.setText(getText(R.string.action_gift));

        itemsAdapter.setOnMoreButtonClickListener(new GiftsListAdapter.OnItemMenuButtonClickListener() {

            @Override
            public void onItemClick(Gift obj, int actionId, int position) {
                ...
                switch (actionId){
                    ...
                    case ITEM_ACTIONS_MENU: {
                        ...
                        alertDialog.setMessage(getText(R.string.label_item_delete_msg));

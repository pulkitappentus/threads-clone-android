...
public class LoginFragment extends Fragment implements Constants {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        cbHidePassword=rootView.findViewById(R.id.cbHidePassword);
        ...
        signinUsername = (EditText) rootView.findViewById(R.id.etUsername);
        signinPassword = (EditText) rootView.findViewById(R.id.etPassword);

        mForgotPassword = (TextView) rootView.findViewById(R.id.tvForgot);
        ...
        signinBtn = (Button) rootView.findViewById(R.id.btnLogin);

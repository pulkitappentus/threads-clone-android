...
public class GuestListAdapter extends RecyclerView.Adapter<GuestListAdapter.MyViewHolder> {
	...
	private final List<Guest> itemList;

	public static class MyViewHolder extends RecyclerView.ViewHolder {

		public TextView mProfileFullname, mProfileUsername,mDistance;
	...
	public void onBindViewHolder(final MyViewHolder holder, int position) {
		...
		holder.mProfileUsername.setText("@" + item.getGuestUserUsername());
		holder.mDistance.setText(item.getTimeAgo());

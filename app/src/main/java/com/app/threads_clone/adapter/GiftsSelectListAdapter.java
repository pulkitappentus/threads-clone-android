...
public class GiftsSelectListAdapter extends RecyclerView.Adapter<GiftsSelectListAdapter.MyViewHolder> {

	private final Context mContext;
	private final List<BaseGift> itemList;
	...
	public GiftsSelectListAdapter(Context mContext, List<BaseGift> itemList) {
	...
	public interface OnItemClickListener {
		...
		void onItemClick(BaseGift obj, int position);
	}
	...
	public void onBindViewHolder(final MyViewHolder holder, final int position) {
		...
		holder.mPriceLabel.setText(String.format(Locale.getDefault(), mContext.getString(R.string.price_of),Integer.valueOf(item.getCost())));

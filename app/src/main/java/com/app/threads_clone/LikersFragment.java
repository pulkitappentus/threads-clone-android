...
import com.app.threads_clone.adapter.LikeListAdapter;
...
public class LikersFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    private LikeListAdapter itemsAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            itemsAdapter = new LikeListAdapter(getActivity(), itemsList);

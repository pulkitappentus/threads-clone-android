...
import com.app.threads_clone.adapter.AdvancedItemListAdapter;
import com.app.threads_clone.adapter.FollowersSpotlightListAdapter;
...
public class CommunityFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String community_mention = i.getStringExtra("groupMention");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        MaterialRippleLayout mMoreButton = (MaterialRippleLayout) rootView.findViewById(R.id.moreButton);

package com.app.threads_clone.constants;
...
public interface Constants {
    ...
    //String API_DOMAIN = "http://35.154.181.95/";
    String API_DOMAIN = "http://3.111.31.119/";  // url address to which the application sends requests || http://10.0.2.2/ - for test on emulator in localhost [XAMPP]

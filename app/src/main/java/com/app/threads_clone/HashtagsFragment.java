...
public class HashtagsFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (!isAdded() || getActivity() == null) {
                            ...
                            Log.e("ERROR", "HashtagsFragment Not Added to Activity");

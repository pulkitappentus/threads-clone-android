...
import com.app.threads_clone.adapter.PeopleNearbyListAdapter;
...
public class PeopleNearbyFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    ImageView mSplash,ivFilter,ivBack;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mPermissionSpotlight = (LinearLayout) rootView.findViewById(R.id.llGrant);
       btnAllowLocation = (Button) rootView.findViewById(R.id.btnAllowLocation);
                        ...
                        mFusedLocationClient.getLastLocation().addOnCompleteListener(getActivity(), new OnCompleteListener<Location>() {
                            ...
                            public void onComplete(@NonNull Task<Location> task) {
                                ...
                                if (task.isSuccessful() && task.getResult() != null) {
                                    ...
                                    Log.d("GPS", "WelcomeActivity onComplete" + mLastLocation.getLatitude());
                                    Log.d("GPS", "WelcomeActivity onComplete" + mLastLocation.getLongitude());
    ...
    public void getItems() {
        ...
        Log.e("Lat & Lng", App.getInstance().getLat() + " & " + App.getInstance().getLng());
    ...
    public void filter() {
        View  view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_nearby_filter, null);
        BottomSheetDialog dialog = new BottomSheetDialog(getActivity(), R.style.AppBottomSheetDialogTheme);
        dialog.setContentView(view);
        dialog.setCancelable(true);
        SeekBar seekbar=dialog.findViewById(R.id.seekbar);
        TextView distanceValue=dialog.findViewById(R.id.tvDistanceValue);
        Button both=dialog.findViewById(R.id.btnBoth);
        Button male=dialog.findViewById(R.id.btnMale);
        Button female=dialog.findViewById(R.id.btnFeMale);
        Button btnApply=dialog.findViewById(R.id.btnApply);

        male.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                male.setBackground(getResources().getDrawable(R.drawable.bg_btn_selected));
                female.setBackground(getResources().getDrawable(R.drawable.bg_btn_unselect));
                both.setBackground(getResources().getDrawable(R.drawable.bg_btn_unselect));
        ...
        female.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                female.setBackground(getResources().getDrawable(R.drawable.bg_btn_selected));
                male.setBackground(getResources().getDrawable(R.drawable.bg_btn_unselect));
                both.setBackground(getResources().getDrawable(R.drawable.bg_btn_unselect));
        ...
        both.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                male.setBackground(getResources().getDrawable(R.drawable.bg_btn_unselect));
                female.setBackground(getResources().getDrawable(R.drawable.bg_btn_unselect));
                both.setBackground(getResources().getDrawable(R.drawable.bg_btn_selected));

...
public class BalanceActivity extends ActivityBase {
    ...
    static final String ITEM_SKU_1 = "app.threads_clone.com.iap1";          // Change to: yourdomain.com.iap1
    static final String ITEM_SKU_2 = "app.threads_clone.com.iap2";          // Change to: yourdomain.com.iap2
    static final String ITEM_SKU_3 = "app.threads_clone.com.ru.iap3";          // Change to: yourdomain.com.iap3
            ...
            if (!purchase.isAcknowledged()) {
                ...
                mBillingClient.acknowledgePurchase(acknowledgePurchaseParams, new AcknowledgePurchaseResponseListener() {
                    ...
                    public void onAcknowledgePurchaseResponse(@NonNull BillingResult billingResult) {
                        //SharedPrefData.SetBooleanPref(activity.getApplicationContext(), "hasPlan", true);
                        //logPurchasedEvent(contentId, currency, totalPrice);
                    }
                });
            }
        }
...
//                for (Purchase purchase : purchases) {
//
//                    consume(purchase.getPurchaseToken(), purchase.getDeveloperPayload(), purchaseing.getSku());
//                }
//            }
//        }).build();
//

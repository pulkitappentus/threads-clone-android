...
import com.app.threads_clone.dialogs.ItemDeleteDialog;
import com.app.threads_clone.model.MarketItem;
...
public class MarketViewItemFragment extends Fragment implements Constants {
    ...
    TextView mItemDate, mItemTitle, mItemPrice, mItemDescription,tvUserName;
    ImageView mItemImg;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        clDelete = (ConstraintLayout) rootView.findViewById(R.id.clDelete);
        ...
        if(isAdded()){
            App.getInstance().getImageLoader().get(App.getInstance().getPhotoUrl(), ImageLoader.getImageListener(userImage, R.drawable.profile_default_photo, R.drawable.profile_default_photo));
    ...
    private void dialogDelete() {
            ...
            TextView tvDeletePost=dialog.findViewById(R.id.tvDeletePost);
            TextView tvDoYouWant=dialog.findViewById(R.id.tvDoYouWant);
            TextView tvCancel=dialog.findViewById(R.id.tvCancel);
            TextView tvYes=dialog.findViewById(R.id.tvYes);
            tvDelete.setText("Delete Listing");
        tvDeletePost.setText("Delete Listing");
        tvDoYouWant.setText("Do you want to delete product listing ?");

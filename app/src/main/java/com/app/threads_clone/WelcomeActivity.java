...
import static com.app.threads_clone.constants.Constants.MY_PERMISSIONS_REQUEST_ACCESS_LOCATION;
import static com.app.threads_clone.constants.Constants.MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE_PHOTO;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private void addMarkers(int currentPage) {
        ...
        TextView[] markers = new TextView[screens.length];

...
import com.app.threads_clone.adapter.GroupsListAdapter;
import com.app.threads_clone.app.App;
import com.app.threads_clone.constants.Constants;
import com.app.threads_clone.model.Group;
import com.app.threads_clone.util.CustomRequest;
import com.app.threads_clone.view.LineItemDecoration;

public class ManagedGroupsFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_managed_groups, container, false);
        ...
        FloatingActionButton mFabButton = (FloatingActionButton) getActivity().findViewById(R.id.fabButton);
    ...
    public void getItems() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_GROUP_GET_MANAGED_GROUPS, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (!isAdded() || getActivity() == null) {
                            ...
                            Log.e("ERROR", "ManagedGroupsFragment Not Added to Activity");

...
public class PrivacySettingsFragment extends PreferenceFragment implements Constants {
    ...
    private SwitchPreference mAllowInfo, mAllowFriends, mAllowGallery, mAllowGifts;

    private ProgressDialog pDialog;

    int allowGallery, allowFriends, allowInfo, allowGifts;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAllowGallery = (SwitchPreference) getPreferenceManager().findPreference("allowGallery");
        ...
        mAllowFriends = (SwitchPreference) getPreferenceManager().findPreference("allowFriends");
        ...
        mAllowGifts = (SwitchPreference) getPreferenceManager().findPreference("allowGifts");
        ...
        mAllowInfo = (SwitchPreference) getPreferenceManager().findPreference("allowInfo");

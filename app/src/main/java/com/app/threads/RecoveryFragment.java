...
public class RecoveryFragment extends Fragment implements Constants {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mEmail = (EditText) rootView.findViewById(R.id.etRecoveryEmail);

        mContinueBtn = (Button) rootView.findViewById(R.id.btnSend);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (!response.getBoolean("error")) {
                                Intent i = new Intent(getActivity(), SentSuccessfullyActivity.class);
                                startActivity(i);

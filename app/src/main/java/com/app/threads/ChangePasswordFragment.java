...
public class ChangePasswordFragment extends Fragment implements Constants {
    ...
    CheckBox cbHidePassword,cbHideNewPassword;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        cbHidePassword = (CheckBox) rootView.findViewById(R.id.cbHidePassword);
        cbHideNewPassword = (CheckBox) rootView.findViewById(R.id.cbHideNewPassword);
        ...
        cbHideNewPassword.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(!isChecked){

package com.app.threads.dialogs;
...
public class ItemDeleteDialog extends DialogFragment implements Constants {
    ...
    OnClickListener positiveListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onItemDelete(position);
        }
    };
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        b.setMessage(getText(R.string.label_item_delete_msg));

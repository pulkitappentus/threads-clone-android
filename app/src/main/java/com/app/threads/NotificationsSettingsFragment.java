...
public class NotificationsSettingsFragment extends PreferenceFragment implements Constants {
    ...
    private SwitchPreference mAllowLikesGCM, mAllowCommentsGCM, mAllowFollowersGCM, mAllowMessagesGCM, mAllowCommentReplyGCM, mAllowGiftsGCM;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAllowLikesGCM = (SwitchPreference) getPreferenceManager().findPreference("allowLikesGCM");
        ...
        mAllowCommentsGCM = (SwitchPreference) getPreferenceManager().findPreference("allowCommentsGCM");
        ...
        mAllowFollowersGCM = (SwitchPreference) getPreferenceManager().findPreference("allowFollowersGCM");
        ...
        mAllowMessagesGCM = (SwitchPreference) getPreferenceManager().findPreference("allowMessagesGCM");
        ...
        mAllowCommentReplyGCM = (SwitchPreference) getPreferenceManager().findPreference("allowCommentReplyGCM");
        ...
        mAllowGiftsGCM = (SwitchPreference) getPreferenceManager().findPreference("allowGiftsGCM");

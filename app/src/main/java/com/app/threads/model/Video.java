...
public class Video extends Application implements Constants, Parcelable {

    private long id, fromUserId;
    private int createAt, likesCount, commentsCount, accessMode, fromUserVerify, fromUserAllowVideoComments;
    private String timeAgo, date, comment, imgUrl, videoUrl, previewImgUrl, originImgUrl, fromUserUsername, fromUserFullname, fromUserPhotoUrl, area, country, city;
    ...
    public Video(JSONObject jsonData) {
        ...
        try {
            ...
            if (!jsonData.getBoolean("error")) {
                ...
                this.setFromUserAllowVideoComments(jsonData.getInt("fromUserAllowVideoComments"));
            ...
            Log.e("VIDEO", "Could not parse malformed JSON: \"" + jsonData.toString() + "\"");

        } finally {

            Log.d("VIDEO", jsonData.toString());
        }
    }
    ...
    public int getFromUserAllowVideoComments() {

        return fromUserAllowVideoComments;
    }

    public void setFromUserAllowVideoComments(int fromUserAllowVideoComments) {

        this.fromUserAllowVideoComments = fromUserAllowVideoComments;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.fromUserAllowVideoComments);
    ...
    protected Video(Parcel in) {
        ...
        this.fromUserAllowVideoComments = in.readInt();

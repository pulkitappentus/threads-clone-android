...
public class Item extends Application implements Constants, Parcelable {
    ...
    private int imagesCount = 0, feeling = 0, createAt, likesCount = 0, commentsCount, rePostsCount, allowComments, groupAllowComments, accessMode = 0, fromUserVerify = 0;
    ...
    private int reImagesCount;
    private String reVideoUrl, rePreviewVideoImgUrl;
    ...
    public Item(JSONObject jsonData) {
        ...
        try {
            ...
            if (!jsonData.getBoolean("error")) {
                ...
                if (jsonData.has("postType")) {

                    this.setPostType(jsonData.getInt("postType"));
                }
                ...
                if (jsonData.has("rePost")) {
                    ...
                    if (rePostArray.length() > 0) {
                        ...
                        if (!rePostObj.getBoolean("error")) {
                            ...
                            if (rePostObj.has("previewVideoImgUrl")) this.setRePreviewVideoImageUrl(rePostObj.getString("previewVideoImgUrl"));
                            if (rePostObj.has("videoUrl")) this.setReVideoUrl(rePostObj.getString("videoUrl"));

                            if (rePostObj.has("imagesCount")) this.setReImagesCount(rePostObj.getInt("imagesCount"));
    ...
    public String getLink() {
        ...
        return WEB_SITE + this.getFromUserUsername() + "/post/" + this.getId();
    }
    ...
    public String getRePreviewVideoImageUrl() {

        if (this.rePreviewVideoImgUrl == null) {

            this.rePreviewVideoImgUrl = "";
        }

        return rePreviewVideoImgUrl;
    }

    public void setRePreviewVideoImageUrl(String rePreviewVideoImgUrl) {

        this.rePreviewVideoImgUrl = rePreviewVideoImgUrl;
    }

    public int getReImagesCount() {

        return reImagesCount;
    }

    public void setReImagesCount(int reImagesCount) {

        this.reImagesCount = reImagesCount;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.rePreviewVideoImgUrl);
        dest.writeInt(this.reImagesCount);
        ...
        dest.writeInt(this.restoreAt);
        dest.writeInt(this.removeAt);
        dest.writeInt(this.allowRestore);

        //niteshkumar.rathi@hdfcbank.com
    }
    ...
    protected Item(Parcel in) {
        ...
        this.rePreviewVideoImgUrl = in.readString();
        this.reImagesCount = in.readInt();
        ...
        this.mediaList = in.readArrayList(MediaItem.class.getClassLoader());
        this.restoreAt = in.readInt();
        this.removeAt = in.readInt();
        this.allowRestore = in.readInt();
    }

...
import com.app.threads.view.ResizableImageView;
...
public class ViewImageFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        itemsAdapter.setOnMoreButtonClickListener(new CommentsListAdapter.OnItemMenuButtonClickListener() {
            ...
            @Override
            public void onItemClick(final Comment obj, int actionId, final int position) {
        ...
        MaterialRippleLayout mLikeButton = rootView.findViewById(R.id.like_button);
        ...
        LinearLayout mSendComment = rootView.findViewById(R.id.sendButton);
        LinearLayout mEmojiButton = rootView.findViewById(R.id.emojiButton);
